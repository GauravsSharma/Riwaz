  ...
  return (
    <div className="p-6 bg-white w-full">
      ...
      <div className="mb-8 flex justify-between items-center w-full">
        <div>
          ...
          <p className="text-gray-500 text-sm">
            You can edit/update your profile information by clicking on the edit
            profile button.
          </p>
        </div>
      ...
      <Link
        ...
        className="bg-purple-500 hover:bg-purple-600 text-white font-medium py-3 px-6 rounded transition-colors"
      >
        EDIT PROFILE
      </Link>
